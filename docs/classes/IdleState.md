...
[@niuee/board](../globals.md) / IdleState

# Class: IdleState

Defined in: [input-state-machine/touch-state-machine.ts:36](https://github.com/niuee/board/blob/cc09a87e934160adef876c4e11d51fd97e78653d/src/input-state-machine/touch-state-machine.ts#L36)
...
> **new IdleState**(): [`IdleState`](IdleState.md)
...
> `protected` **\_guards**: [`Guard`](../type-aliases/Guard.md)\<[`TouchContext`](../interfaces/TouchContext.md), `"touchPointsCount"`\>

Defined in: [input-state-machine/touch-state-machine.ts:51](https://github.com/niuee/board/blob/cc09a87e934160adef876c4e11d51fd97e78653d/src/input-state-machine/touch-state-machine.ts#L51)
...
Defined in: [input-state-machine/touch-state-machine.ts:68](https://github.com/niuee/board/blob/cc09a87e934160adef876c4e11d51fd97e78653d/src/input-state-machine/touch-state-machine.ts#L68)
...
> **touchend**(`stateMachine`, `context`, `payload`): `"IDLE"` \| `"PENDING"`

Defined in: [input-state-machine/touch-state-machine.ts:77](https://github.com/niuee/board/blob/cc09a87e934160adef876c4e11d51fd97e78653d/src/input-state-machine/touch-state-machine.ts#L77)
...
Defined in: [input-state-machine/touch-state-machine.ts:72](https://github.com/niuee/board/blob/cc09a87e934160adef876c4e11d51fd97e78653d/src/input-state-machine/touch-state-machine.ts#L72)
